...
bool set_config (config_t *config, const int argc, char **argv){
    ...
    *config = (config_t){
        ...
        .fg_color = 0xFFFFFFFF, 
        .bg_color = 0x000000FF, //Yellow initially, testing if its showing yellow. If its not, then the ordering is different. 
        .scale_factor = 20,
        .pixel_outlines = true, // Draw pixel outlines by default. 
        .inst_per_second = 700, // Number of instructions to emulate in 1 second (clock rate of CPU)
